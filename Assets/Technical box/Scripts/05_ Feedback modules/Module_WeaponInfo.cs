...
/// Class description
/// </summary>
public class Module_WeaponInfo : MonoBehaviour
{
    [Header("REFERENCES")]
    ...
    private void Display(Module_WeaponSelectionButton weaponSelectionButton)
    {
    ...
    private void WeaponSelectionButton_OnAnyWeaponSelectionButtonEnter(object sender, Module_WeaponSelectionButton enteredButton)
    {
        Display(enteredButton);
    }
    
    private void WeaponSelectionButton_OnAnyWeaponSelectionButtonExit(object sender, Module_WeaponSelectionButton exitedButton)
    {
        Hide();
    }
}