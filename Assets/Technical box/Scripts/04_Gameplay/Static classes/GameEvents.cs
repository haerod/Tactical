...
public static class GameEvents
{
    ...
    public static event EventHandler<Unit> OnAnyAttackExecute;
    ...
    public static void InvokeOnAnyAttackExecute(Unit attackingUnit) => OnAnyAttackExecute?.Invoke(null, attackingUnit);
